export const seoConfig = {
  ...
  impressum: {
    ...
    description:
      "Impressum und Kontaktinformationen von 22Orbit - Webentwicklung & Digitale Lösungen aus Magdeburg.",
  ...
  datenschutz: {
    ...
    description:
      "Datenschutzerklärung von 22Orbit. Informationen zur Verarbeitung personenbezogener Daten gemäß DSGVO.",
